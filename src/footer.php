...
<section id="lh" class="footer">
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h3>CÔNG TY CỔ PHẦN TÀU CAO TỐC PHÚ QUỐC</h3>
            <br>  
            <ul>
			  <li>Văn phòng đại diện TP.HCM</li>
              <li>1142 Huỳnh Tấn Phát, phường Phú Thuận, quận 7, Hồ Chí Minh</li>
              <li>Phone: 0283.873.2459</li>
        ...
        <div class="col-sm-3">
            <h3>Liên hệ đăng ký đại lý:</h3>
            <br>
            
            <ul><li>info@tau.vn</li>
            <li>0283.873.2459</li></ul>
...
<section class="copyright">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="copyrightInner">@ 2019 Copyright by tau.vn</div>
      </div>
    </div>
  </div>
</section>
